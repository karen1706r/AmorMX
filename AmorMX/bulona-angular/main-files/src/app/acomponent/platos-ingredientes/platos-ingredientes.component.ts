...
private loadPlatosingredientes(): void {
  ...
  private groupIngredientsByPlato(): void {
    ...
    // Verificar IDs
    console.log('IDs de platos ingredientes:', this.platosingredientes.map(pi => pi.id_plato));
    console.log('IDs de platos:', this.platos.map(p => p.id));
    ...
    this.groupedPlatos = Object.values(grouped);
    console.log('Platos agrupados:', this.groupedPlatos);
  }
